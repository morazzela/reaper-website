            ...
            <div className="flex mt-4 items-start">
                <div className="w-full flex items-end flex-col">
                    ...
                    <div className="mt-1 flex justify-between w-full">
                        <span className="italic font-mono text-xs">Minimum deposit is 300,000 ${symbol}</span>
                ...
                <button className="btn bg-black text-white ml-2" disabled={!value.gt(minimum) || value.gt(balance) || approving || depositing} onClick={onDepositClick}>
                    {approving && "Approving..."}
